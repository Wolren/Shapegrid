...
const WIDGET_THEMES: { name: string; palettes: Record<string, WidgetPalette> }[] = [
  ...
  },
  {
    ...
    palettes: {
      ...
      languages:    { accent: '#fbbf24', secondary: '#b45309' },
  ...
  },
  {
    ...
    palettes: {
      ...
      coordinates:  { accent: '#94a3b8', secondary: '#64748b' },
      distribution: { accent: '#22d3ee', secondary: '#0891b2' },
      timeline:     { accent: '#60a5fa', secondary: '#1d4ed8' },
      activity:     { accent: '#818cf8', secondary: '#4338ca' },
      topCells:     { accent: '#38bdf8', secondary: '#0369a1' },
      weekday:      { accent: '#2dd4bf', secondary: '#0f766e' },
      streak:       { accent: '#22d3ee', secondary: '#0891b2' },
      monthly:      { accent: '#60a5fa', secondary: '#1d4ed8' },
  ...
  },
  {
    name: 'Cyber',
    palettes: {
      legend:       { accent: '#22d3ee', secondary: '#0e7490' },
      stats:        { accent: '#a78bfa', secondary: '#6d28d9' },
      languages:    { accent: '#e879f9', secondary: '#a21caf' },
      cellInfo:     { accent: '#f472b6', secondary: '#be185d' },
      scaleBar:     { accent: '#22d3ee', secondary: '#0e7490' },
      coordinates:  { accent: '#8fa3c9', secondary: '#64748b' },
      distribution: { accent: '#fb7185', secondary: '#be123c' },
      timeline:     { accent: '#22d3ee', secondary: '#0e7490' },
      activity:     { accent: '#c084fc', secondary: '#7e22ce' },
      topCells:     { accent: '#f472b6', secondary: '#be185d' },
      weekday:      { accent: '#2dd4bf', secondary: '#0f766e' },
      streak:       { accent: '#fb7185', secondary: '#be123c' },
      monthly:      { accent: '#a78bfa', secondary: '#6d28d9' },
      geo:          { accent: '#c084fc', secondary: '#7e22ce' },
      minimap:      { accent: '#22d3ee', secondary: '#0e7490' },
    },
  },
];
