...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new W(0,1,0);return new Gi({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(){return new Gi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(){return new Gi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `,r.querySelector(`:scope > .palette-item-name`)?.addEventListener(`click`,()=>{_u(t),Fu=[...n.colors],Pu=0,Iu(),Lu(),Tu(),zu()}),r.querySelector(`:scope > .palette-item-swatches`)?.addEventListener(`click`,()=>{_u(t),Fu=[...n.colors],Pu=0,Iu(),Lu(),Tu(),zu()});let o=r.querySelector(`.palette-delete`);o&&o.addEventListener(`click`,e=>{e.stopPropagation(),bu(t),Iu(),zu()}),e.appendChild(r)}))}function Lu(){Fu=[...(du[fu]||du.github).colors];let e=document.getElementById(`palette-swatches`);if(e&&(e.innerHTML=``,Fu.forEach((t,n)=>{let r=document.createElement(`div`);if(r.className=`swatch`+(n===Pu?` active`:``),r.style.background=t,r.title=t,r.addEventListener(`click`,e=>{if(e.target.classList.contains(`swatch-remove`))return;Pu=n;let r=document.getElementById(`swatch-color-picker`),i=document.getElementById(`swatch-color-hex`);r&&(r.value=t),i&&(i.value=t),Lu()}),Fu.length>2){let e=document.createElement(`div`);e.className=`swatch-remove`,e.textContent=`×`,e.addEventListener(`click`,e=>{e.stopPropagation(),Fu.splice(n,1),Pu>=Fu.length&&(Pu=Fu.length-1),Ru();let t=document.getElementById(`swatch-color-picker`),r=document.getElementById(`swatch-color-hex`);t&&Fu[Pu]&&(t.value=Fu[Pu]),r&&Fu[Pu]&&(r.value=Fu[Pu])}),r.appendChild(e)}e.appendChild(r)}),Fu.length<8)){let t=document.createElement(`div`);t.className=`swatch-add`,t.textContent=`+`,t.addEventListener(`click`,()=>{Fu.push(`#ffffff`),Pu=Fu.length-1,Ru()}),e.appendChild(t)}}function Ru(){vu(fu,[...Fu]),Lu(),Iu(),Tu(),zu()}function zu(){let e=document.getElementById(`legend-bar`);if(!e)return;let t=(du[fu]||du.github).colors.join(`, `);e.style.background=`linear-gradient(to right, ${t})`}function Bu(){Iu(),Lu(),zu();let e=document.getElementById(`swatch-color-picker`),t=document.getElementById(`swatch-color-hex`),n=document.getElementById(`btn-swatch-apply`),r=document.getElementById(`btn-save-palette`),i=document.getElementById(`new-palette-name`);e&&e.addEventListener(`input`,e=>{let n=e.target;t&&(t.value=n.value),Fu[Pu]=n.value,Ru()}),n&&n.addEventListener(`click`,()=>{if(!t)return;let n=t.value.trim();if(n.startsWith(`#`)||(n=`#`+n),!/^#[0-9a-fA-F]{6}$/.test(n)){Vu(`Invalid hex color`,`error`);return}Fu[Pu]=n,e&&(e.value=n),Ru()}),t&&t.addEventListener(`change`,()=>{n?.click()}),r&&r.addEventListener(`click`,()=>{let e=i?.value.trim()||`Custom`;_u(yu(e,[...Fu])),Iu(),Lu(),i&&(i.value=``),Vu(`Palette "${e}" saved`,`ok`),Tu(),zu()})}function Vu(e,t){let n=document.getElementById(`status-line`);n&&(n.textContent=e,n.className=t||``)}var Hu=class extends mn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Ni;e.deleteAttribute(`uv`);let t=new qi({side:1}),n=new qi,r=new Ta(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new Xr(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new ci(e,n,6),o=new rn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new Xr(e,Uu(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new Xr(e,Uu(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new Xr(e,Uu(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new Xr(e,Uu(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new Xr(e,Uu(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new Xr(e,Uu(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Uu(e){return new Ji({color:0,emissive:16777215,emissiveIntensity:e})}function Wu(e){return e}function Gu(e){if(e==null)return Wu;var t,n,r=e.scale[0],i=e.scale[1],a=e.translate[0],o=e.translate[1];return function(e,s){s||(t=n=0);var c=2,l=e.length,u=Array(l);for(u[0]=(t+=e[0])*r+a,u[1]=(n+=e[1])*i+o;c<l;)u[c]=e[c],++c;return u}}function Ku(e,t){for(var n,r=e.length,i=r-t;i<--r;)n=e[i],e[i++]=e[r],e[r]=n}function qu(e,t){return typeof t==`string`&&(t=e.objects[t]),t.type===`GeometryCollection`?{type:`FeatureCollection`,features:t.geometries.map(function(t){return Ju(e,t)})}:Ju(e,t)}function Ju(e,t){var n=t.id,r=t.bbox,i=t.properties==null?{}:t.properties,a=Yu(e,t);return n==null&&r==null?{type:`Feature`,properties:i,geometry:a}:r==null?{type:`Feature`,id:n,properties:i,geometry:a}:{type:`Feature`,id:n,bbox:r,properties:i,geometry:a}}function Yu(e,t){var n=Gu(e.transform),r=e.arcs;function i(e,t){t.length&&t.pop();for(var i=r[e<0?~e:e],a=0,o=i.length;a<o;++a)t.push(n(i[a],a));e<0&&Ku(t,o)}function a(e){return n(e)}function o(e){for(var t=[],n=0,r=e.length;n<r;++n)i(e[n],t);return t.length<2&&t.push(t[0]),t}function s(e){for(var t=o(e);t.length<4;)t.push(t[0]);return t}function c(e){return e.map(s)}function l(e){var t=e.type,n;switch(t){case`GeometryCollection`:return{type:t,geometries:e.geometries.map(l)};case`Point`:n=a(e.coordinates);break;case`MultiPoint`:n=e.coordinates.map(a);break;case`LineString`:n=o(e.arcs);break;case`MultiLineString`:n=e.arcs.map(o);break;case`Polygon`:n=c(e.arcs);break;case`MultiPolygon`:n=e.arcs.map(c);break;default:return null}return{type:t,coordinates:n}}return l(t)}var Xu=`https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json`,Zu={"004":`AF`,"008":`AL`,"012":`DZ`,"020":`AD`,"024":`AO`,"032":`AR`,"036":`AU`,"040":`AT`,"050":`BD`,"051":`AM`,"056":`BE`,"064":`BT`,"068":`BO`,"076":`BR`,100:`BG`,104:`MM`,116:`KH`,120:`CM`,124:`CA`,144:`LK`,148:`TD`,152:`CL`,156:`CN`,158:`TW`,170:`CO`,180:`CD`,188:`CR`,191:`HR`,192:`CU`,196:`CY`,203:`CZ`,204:`BJ`,208:`DK`,214:`DO`,218:`EC`,222:`SV`,231:`ET`,233:`EE`,246:`FI`,250:`FR`,266:`GA`,268:`GE`,276:`DE`,300:`GR`,320:`GT`,324:`GN`,328:`GY`,332:`HT`,340:`HN`,348:`HU`,352:`IS`,356:`IN`,360:`ID`,364:`IR`,368:`IQ`,372:`IE`,376:`IL`,380:`IT`,384:`CI`,388:`JM`,392:`JP`,398:`KZ`,400:`JO`,404:`KE`,408:`KP`,410:`KR`,414:`KW`,417:`KG`,418:`LA`,422:`LB`,426:`LS`,428:`LV`,434:`LY`,440:`LT`,442:`LU`,450:`MG`,454:`MW`,458:`MY`,466:`ML`,478:`MR`,484:`MX`,496:`MN`,504:`MA`,508:`MZ`,512:`OM`,516:`NA`,524:`NP`,528:`NL`,540:`NC`,554:`NZ`,558:`NI`,562:`NE`,566:`NG`,578:`NO`,586:`PK`,591:`PA`,598:`PG`,600:`PY`,604:`PE`,608:`PH`,616:`PL`,620:`PT`,624:`GW`,634:`QA`,642:`RO`,643:`RU`,646:`RW`,682:`SA`,686:`SN`,694:`SL`,702:`SG`,703:`SK`,704:`VN`,705:`SI`,710:`ZA`,716:`ZW`,724:`ES`,728:`SS`,729:`SD`,732:`EH`,740:`SR`,748:`SZ`,752:`SE`,756:`CH`,760:`SY`,762:`TJ`,764:`TH`,768:`TG`,780:`TT`,784:`AE`,788:`TN`,792:`TR`,795:`TM`,800:`UG`,804:`UA`,807:`MK`,818:`EG`,826:`GB`,834:`TZ`,840:`US`,854:`BF`,858:`UY`,860:`UZ`,862:`VE`,887:`YE`,894:`ZM`},Qu={US:`United States`,GB:`United Kingdom`,CZ:`Czech Republic`,KR:`South Korea`,RU:`Russia`,IR:`Iran`,SY:`Syria`,VN:`Vietnam`,TW:`Taiwan`,CD:`DR Congo`,CI:`Côte d'Ivoire`,MM:`Myanmar`,MK:`North Macedonia`},$u=null,ed=null;async function td(){return $u||ed||(ed=(async()=>{try{let e=await(await fetch(Xu)).json(),t=qu(e,e.objects.countries),n={};for(let e of t.features){let t=Zu[String(e.id).padStart(3,`0`)];if(!t)continue;let r=Qu[t]||e.properties?.name||t,i=null;if(e.geometry.type===`Polygon`)i=e.geometry.coordinates[0].map(e=>[e[0],e[1]]);else if(e.geometry.type===`MultiPolygon`){let t=null,n=0;for(let r of e.geometry.coordinates){let e=r[0].map(e=>[e[0],e[1]]),i=e.map(e=>e[0]),a=e.map(e=>e[1]),o=(Math.max(...i)-Math.min(...i))*(Math.max(...a)-Math.min(...a));o>n&&(n=o,t=e)}i=t}if(!i||i.length<4)continue;let a=i;if(a.length>150){let e=Math.ceil(a.length/150);i=a.filter((t,n)=>n%e===0||n===a.length-1)}n[t]={name:r,coords:bl(i,`wgs84`)}}return $u=n,console.log(`[countries] Loaded ${Object.keys(n).length} countries`),n}catch(e){return console.error(`[countries] Failed to load:`,e),{}}})(),ed)}function nd(){return $u}var rd=[`US`,`CA`,`GB`,`FR`,`DE`,`IT`,`ES`,`JP`,`CN`,`KR`,`IN`,`AU`,`BR`,`MX`,`NL`,`SE`,`PL`,`NO`,`CH`,`AR`],id=null;function ad(){return id||=td().then(()=>{}),id}function od(){let e=nd();return e?Object.entries(e).map(([e,t])=>({code:e,name:t.name})).sort((e,t)=>e.name.localeCompare(t.name)):rd.map(e=>({code:e,name:e}))}function sd(e){let t=e.toLowerCase();return od().filter(e=>e.name.toLowerCase().includes(t)||e.code.toLowerCase().includes(t))}var cd=new Proxy({},{get(e,t){return nd()?.[t]??null},has(e,t){return nd()?.[t]!==void 0},ownKeys(){return Object.keys(nd()||{})}}),ld={select:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M3 1v13l3.5-3.5L10 14l1-2.5L14 10z"/></svg>`,pan:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M8 1v6M5 3l3-2 3 2M1 8h6M3 5l-2 3 2 3M15 8H9M13 5l2 3-2 3M8 15V9M5 13l3 2 3-2"/></svg>`,measureDistance:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M1 4l3-3 3 3M1 12l3 3 3-3M1 4v8M1 14h14M14 4l-3-3-3 3M14 12l-3 3-3-3M14 4v8"/></svg>`,measureArea:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h10v10H3z"/><path d="M3 3l2 2M13 3l-2 2M13 13l-2-2M3 13l2-2M6 3v2M10 3v2M3 6h2M3 10h2M13 6h-2M13 10h-2M6 13v-2M10 13v-2"/></svg>`,zoomToFit:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M5 1H2v3M11 1h3v3M5 15H2v-3M11 15h3v-3M2 8h12M8 2v12"/></svg>`,resetCamera:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="5"/><path d="M8 5v3l2 1.5"/></svg>`,topDown:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><circle cx="8" cy="8" r="2"/></svg>`,screenshot:`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="12" height="10" rx="1.5"/><circle cx="8" cy="9" r="3"/><path d="M5 4l1-2h4l1 2"/></svg>`},ud=[{id:`select`,label:`Select`,iconKey:`select`},{id:`pan`,label:`Pan`,iconKey:`pan`},{id:`measureDistance`,label:`Measure Distance`,iconKey:`measureDistance`},{id:`measureArea`,label:`Measure Area`,iconKey:`measureArea`}],dd=[{id:`zoom-to-fit`,label:`Zoom to fit`,iconKey:`zoomToFit`},{id:`reset-camera`,label:`Reset camera`,iconKey:`resetCamera`},{id:`top-down`,label:`Top-down view`,iconKey:`topDown`}],fd=[{id:`boundary`,label:`Boundary`},{id:`grid`,label:`Grid`},{id:`axes`,label:`Axes`}],pd=!1;function md(){if(pd)return;pd=!0;let e=document.createElement(`style`);e.textContent=`
#editor-toolbar {
  position: absolute;
  top: 0;
  left: 0;
...
`,document.head.appendChild(e)}function hd(e){return ld[e]||``}function gd(e){let t=document.createElement(`button`);return t.type=`button`,t.className=`tool-btn`,t.dataset.tool=e.id,t.dataset.tip=e.label,t.innerHTML=hd(e.iconKey),t}function _d(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`action-btn`,r.dataset.action=e,r.dataset.tip=t,r.innerHTML=hd(n),r}function vd(){let e=document.createElement(`div`);return e.className=`toolbar-sep`,e.ariaHidden=`true`,e}function yd(e,t){let n=document.createElement(`label`);n.className=`layer-toggle`;let r=document.createElement(`input`);r.type=`checkbox`,r.dataset.layer=e,r.addEventListener(`change`,()=>{Tl(e,r.checked),Tu()});let i=document.createElement(`span`);return i.textContent=t,n.appendChild(r),n.appendChild(i),n}function bd(e){md();let t=document.getElementById(`editor-toolbar`);t&&t.remove();let n=document.createElement(`div`);n.id=`editor-toolbar`;let r=document.createElement(`div`);r.className=`toolbar-group`;for(let e of ud){let t=gd(e);t.addEventListener(`click`,()=>{wl(e.id),xd()}),r.appendChild(t)}n.appendChild(r),n.appendChild(vd());let i=document.createElement(`div`);i.className=`toolbar-group`;for(let t of dd){let n=_d(t.id,t.label,t.iconKey);switch(t.id){case`zoom-to-fit`:n.addEventListener(`click`,()=>{e?.zoomToFit?.()});break;case`reset-camera`:n.addEventListener(`click`,()=>{e?.resetCamera?.()});break;case`top-down`:n.addEventListener(`click`,()=>{e?.topDownView?.()})}i.appendChild(n)}n.appendChild(i),n.appendChild(vd());let a=document.createElement(`div`);a.className=`toolbar-group`;for(let e of fd)a.appendChild(yd(e.id,e.label));n.appendChild(a);let o=document.createElement(`div`);o.className=`toolbar-spacer`,n.appendChild(o);let s=document.createElement(`div`);s.className=`toolbar-group`;let c=_d(`screenshot`,`Screenshot`,`screenshot`);c.addEventListener(`click`,()=>{e?.screenshot?.()}),s.appendChild(c),n.appendChild(s);let l=document.getElementById(`canvas-wrap`);return l&&l.appendChild(n),xd(),n}function xd(){let e=Cl(),t=document.querySelectorAll(`#editor-toolbar .tool-btn`);for(let n of t){let t=n.dataset.tool;t&&n.classList.toggle(`active`,t===e.activeTool)}let n=document.querySelectorAll(`#editor-toolbar [data-layer]`);for(let t of n){let n=t.dataset.layer;n&&(t.checked=e.layerVisibility[n])}}var Sd=`http://www.w3.org/2000/svg`,Cd=`#39d353`,wd=`rgba(57, 211, 83, 0.15)`,Td=4,Ed=2,Dd=12,Q=null,Od=null,kd=null;function Ad(){if(Q)return()=>{};let e=document.getElementById(`canvas-wrap`);if(!e)return console.warn(`[measure] #canvas-wrap not found`),()=>{};let t=document.getElementById(`canvas-main`);if(!t)return console.warn(`[measure] #canvas-main not found`),()=>{};Q=document.createElementNS(Sd,`svg`),Q.id=`measure-overlay`,Q.setAttribute(`style`,`
    position: absolute;
    inset: 0;
    width: 100%;
    height: 100%;
    ...
    overflow: hidden;
    z-index: 15;
  `),Od=document.createElementNS(Sd,`defs`);let n=document.createElementNS(Sd,`marker`);n.setAttribute(`id`,`measure-arrow`),n.setAttribute(`markerWidth`,`6`),n.setAttribute(`markerHeight`,`6`),n.setAttribute(`refX`,`5`),n.setAttribute(`refY`,`3`),n.setAttribute(`orient`,`auto`);let r=document.createElementNS(Sd,`path`);return r.setAttribute(`d`,`M0,0 L6,3 L0,6 Z`),r.setAttribute(`fill`,Cd),n.appendChild(r),Od.appendChild(n),Q.appendChild(Od),e.appendChild(Q),kd=new ResizeObserver(()=>{Q&&(Q.style.width=t.clientWidth+`px`,Q.style.height=t.clientHeight+`px`)}),kd.observe(t),()=>{kd&&=(kd.disconnect(),null),Q&&Q.parentNode&&Q.parentNode.removeChild(Q),Q=null,Od=null}}function jd(e,t,n){let r=e.clone().project(t),i=(r.x*.5+.5)*n.width,a=(-r.y*.5+.5)*n.height;return r.z>1?null:{x:i,y:a}}var Md=new qa,Nd=new fi(new W(0,1,0),0),Pd=new U;function Fd(e,t,n,r){Pd.x=(e-n.left)/n.width*2-1,Pd.y=-((t-n.top)/n.height)*2+1,Md.setFromCamera(Pd,r);let i=new W;return Md.ray.intersectPlane(Nd,i)}function Id(e,t=!1){let n=document.createElementNS(Sd,`g`);if(e.length<2)return n;let r=e.map((e,t)=>t===0?`M ${e.x.toFixed(1)},${e.y.toFixed(1)}`:`L ${e.x.toFixed(1)},${e.y.toFixed(1)}`).join(` `);t&&e.length>2&&(r+=` Z`);let i=document.createElementNS(Sd,`path`);return i.setAttribute(`d`,r),i.setAttribute(`fill`,`none`),i.setAttribute(`stroke`,Cd),i.setAttribute(`stroke-width`,String(Ed)),i.setAttribute(`stroke-linecap`,`round`),i.setAttribute(`stroke-linejoin`,`round`),i.setAttribute(`marker-end`,`url(#measure-arrow)`),n.appendChild(i),n}function Ld(e){let t=document.createElementNS(Sd,`g`);if(e.length<3)return t;let n=e.map((e,t)=>t===0?`M ${e.x.toFixed(1)},${e.y.toFixed(1)}`:`L ${e.x.toFixed(1)},${e.y.toFixed(1)}`).join(` `)+` Z`,r=document.createElementNS(Sd,`path`);return r.setAttribute(`d`,n),r.setAttribute(`fill`,wd),r.setAttribute(`stroke`,Cd),r.setAttribute(`stroke-width`,String(Ed)),r.setAttribute(`stroke-linecap`,`round`),r.setAttribute(`stroke-linejoin`,`round`),t.appendChild(r),t}function Rd(e){let t=document.createElementNS(Sd,`g`);return e.forEach(e=>{let n=document.createElementNS(Sd,`circle`);n.setAttribute(`cx`,e.x.toFixed(1)),n.setAttribute(`cy`,e.y.toFixed(1)),n.setAttribute(`r`,String(Td)),n.setAttribute(`fill`,Cd),n.setAttribute(`opacity`,`0.9`),t.appendChild(n)}),t}function zd(e,t,n,r){let i=document.createElementNS(Sd,`g`),a=t[t.length-1];if(!a)return i;let o=a.x+Dd,s=a.y-Dd;o+80>r.width&&(o=a.x-80),s<40&&(s=a.y+Dd);let c=e.length*6.5+8,l=document.createElementNS(Sd,`rect`);l.setAttribute(`x`,(o-4).toFixed(1)),l.setAttribute(`y`,(s-16+4).toFixed(1)),l.setAttribute(`width`,String(c)),l.setAttribute(`height`,`16`),l.setAttribute(`rx`,`3`),l.setAttribute(`fill`,`rgba(13, 17, 23, 0.8)`),l.setAttribute(`stroke`,Cd),l.setAttribute(`stroke-width`,`1`),i.appendChild(l);let u=document.createElementNS(Sd,`text`);return u.setAttribute(`x`,o.toFixed(1)),u.setAttribute(`y`,s.toFixed(1)),u.setAttribute(`fill`,`#e6edf3`),u.setAttribute(`font-family`,`'IBM Plex Mono', monospace`),u.setAttribute(`font-size`,`9`),u.setAttribute(`alignment-baseline`,`baseline`),u.textContent=e,i.appendChild(u),i}function Bd(e,t,n){return e.map(([e,r])=>{let i=new W(e-.5,0,r-.5),a=jd(i,t,n);return a?{x:a.x,y:a.y,world:i}:null}).filter(e=>e!==null)}function Vd(e,t){if(!Q)return;for(;Q.childNodes.length>1;)Q.removeChild(Q.lastChild);let n=Cl(),r=t.width,i=t.height;Q.setAttribute(`viewBox`,`0 0 ${r} ${i}`);for(let r of n.measurements){let n=Bd(r.points,e,t);if(n.length<2)continue;if(r.type===`area`){let e=Ld(n);Q.appendChild(e)}else{let e=Id(n,!1);Q.appendChild(e)}let i=Rd(n);Q.appendChild(i);let a=zd(r.type===`distance`?`Dist: ${r.distance===void 0?`—`:r.distance.toFixed(2)}`:`Area: ${r.area===void 0?`—`:r.area.toFixed(2)}`,n,e,t);Q.appendChild(a)}let a=n.activeMeasurement;if(a&&a.points.length>0){let n=Bd(a.points,e,t);if(n.length>=1){if(n.length>=2)if(a.type===`area`){let e=Ld(n);Q.appendChild(e)}else{let e=Id(n,!1);Q.appendChild(e)}let r=Rd(n);Q.appendChild(r);let i;if(a.type===`distance`)i=a.distance===void 0?`Dist: —`:`Dist: ${a.distance.toFixed(2)}`;else if(a.area!==void 0)i=`Area: ${a.area.toFixed(2)}`;else if(a.points.length>=2){let e=a.points[a.points.length-1],t=a.points[a.points.length-2],n=e[0]-t[0],r=e[1]-t[1];i=`Edge: ${Math.sqrt(n*n+r*r).toFixed(2)}`}else i=`Area: —`;let o=zd(i,n,e,t);Q.appendChild(o)}}}function Hd(e,t,n,r){let i=Cl(),a=i.activeTool;if(a!==`measureDistance`&&a!==`measureArea`)return!1;let o=Fd(e,t,n,r);if(!o)return!1;let s=o.x+.5,c=o.z+.5;return i.activeMeasurement||Dl(a===`measureDistance`?`distance`:`area`),Ol(s,c),!0}function Ud(){if(Q)for(;Q.childNodes.length>1;)Q.removeChild(Q.lastChild)}function Wd(){return Cl().activeMeasurement!==null}var Gd=null;function Kd(e,t){Gd=e,e.id=`cell-info-body`,e.style.padding=`6px 8px`,e.style.minHeight=`36px`,e.style.fontSize=`10px`,qd()}function qd(){let e=Gd;if(!e)return;let t=Cl().selectedCellIndices,n=X.grid,r=X.cellData??[];if(t.length===0||!n?.cells){e.innerHTML=`<div class="dw-cell-empty">Hover over a cell</div>`;return}e.innerHTML=``,e.style.display=`block`;for(let i of t.slice(0,5)){let a=n.cells[i];if(!a)continue;let o=r[i],s=o?.date||`—`,c=o?.count||0,l=o?.intensity||0,u=document.createElement(`div`);u.style.marginBottom=t.length>1?`4px`:`0`;let d=document.createElement(`div`);d.style.display=`flex`,d.style.justifyContent=`space-between`,d.style.alignItems=`center`,d.innerHTML=`<span style="color:#e6edf3;font-weight:600">${s}</span><span style="color:rgba(255,255,255,0.4);font-size:9px">(${a.col},${a.row})</span>`,u.appendChild(d);let f=document.createElement(`div`);f.style.display=`flex`,f.style.alignItems=`center`,f.style.gap=`6px`,f.style.marginTop=`2px`;let p=document.createElement(`span`);p.textContent=c.toLocaleString(),p.style.cssText=`color:#e6edf3;font-weight:600;font-variant-numeric:tabular-nums;min-width:28px`;let m=document.createElement(`div`);m.style.cssText=`flex:1;height:6px;background:rgba(255,255,255,0.08);border-radius:3px;overflow:hidden`;let h=document.createElement(`div`);h.style.width=`${Math.min(l*100,100)}%`,h.style.height=`100%`,h.style.background=hu(l,fu),h.style.borderRadius=`3px`,m.appendChild(h),f.appendChild(p),f.appendChild(m),u.appendChild(f),e.appendChild(u)}if(t.length>5){let n=document.createElement(`div`);n.textContent=`+${t.length-5} more`,n.style.cssText=`color:rgba(255,255,255,0.4);font-size:9px;margin-top:4px`,e.appendChild(n)}}function Jd(){qd()}Wl(`cellInfo`,Kd);var Yd=[{id:`legend`,title:`Legend`,settings:[{key:`fontSize`,label:`Font size`,type:`range`,min:8,max:24,step:1},{key:`width`,label:`Widget width`,type:`range`,min:120,max:400,step:10}]},{id:`stats`,title:`Statistics`,settings:[{key:`fontSize`,label:`Font size`,type:`range`,min:8,max:24,step:1},{key:`width`,label:`Widget width`,type:`range`,min:160,max:400,step:10}]},{id:`distribution`,title:`Distribution`,settings:[{key:`bins`,label:`Number of bins`,type:`range`,min:3,max:20,step:1},{key:`width`,label:`Widget width`,type:`range`,min:140,max:400,step:10}]},{id:`timeline`,title:`Timeline`,settings:[{key:`days`,label:`Days shown`,type:`range`,min:14,max:365,step:7},{key:`width`,label:`Widget width`,type:`range`,min:140,max:400,step:10}]},{id:`activity`,title:`Activity`,settings:[{key:`days`,label:`Days shown`,type:`range`,min:14,max:182,step:7},{key:`width`,label:`Widget width`,type:`range`,min:140,max:400,step:10}]},{id:`overview`,title:`Overview`,settings:[{key:`size`,label:`Map size`,type:`range`,min:60,max:200,step:10},{key:`width`,label:`Widget width`,type:`range`,min:120,max:350,step:10}]},{id:`languages`,title:`Languages`,settings:[{key:`maxItems`,label:`Max items`,type:`range`,min:1,max:20,step:1},{key:`width`,label:`Widget width`,type:`range`,min:140,max:350,step:10}]},{id:`cellInfo`,title:`Cell Info`,settings:[{key:`fontSize`,label:`Font size`,type:`range`,min:8,max:24,step:1},{key:`width`,label:`Widget width`,type:`range`,min:140,max:350,step:10}]},{id:`scaleBar`,title:`Scale`,settings:[{key:`width`,label:`Widget width`,type:`range`,min:120,max:350,step:10}]},{id:`coordinates`,title:`Coordinates`,settings:[{key:`decimals`,label:`Decimals`,type:`range`,min:0,max:6,step:1},{key:`width`,label:`Widget width`,type:`range`,min:120,max:350,step:10}]}],Xd=[{value:`topLeft`,label:`Top Left`},{value:`topRight`,label:`Top Right`},{value:`bottomLeft`,label:`Bottom Left`},{value:`bottomRight`,label:`Bottom Right`},{value:`left`,label:`Left`},{value:`right`,label:`Right`}],Zd=null,Qd=!1;function $d(){if(Qd)return;Qd=!0;let e=document.createElement(`style`);e.textContent=`
...
`,document.head.appendChild(e)}function ef(e,t){let n=document.createElement(`div`);n.className=`dm-settings-row`;let r=document.createElement(`span`);if(r.className=`dm-settings-label`,r.textContent=e.label,n.appendChild(r),e.type===`range`){let r=document.createElement(`input`);r.type=`range`,r.min=String(e.min??0),r.max=String(e.max??100),r.step=String(e.step??1);let i=X.dashboard.widgets.find(e=>e.id===t);r.value=String(i?.settings?.[e.key]??e.min??0),r.addEventListener(`input`,()=>{Ll(t,e.key,parseFloat(r.value)),Xl(),nf(t)}),n.appendChild(r);let a=document.createElement(`span`);a.className=`dm-settings-value`,a.dataset.settingKey=e.key,a.dataset.widgetId=t,a.textContent=r.value,n.appendChild(a)}else if(e.type===`checkbox`){let r=document.createElement(`input`);r.type=`checkbox`,r.checked=!!X.dashboard.widgets.find(e=>e.id===t)?.settings?.[e.key],r.addEventListener(`change`,()=>{Ll(t,e.key,r.checked),Xl()}),n.appendChild(r)}else if(e.type===`select`&&e.options){let r=document.createElement(`select`);for(let t of e.options){let e=document.createElement(`option`);e.value=t.value,e.textContent=t.label,r.appendChild(e)}let i=X.dashboard.widgets.find(e=>e.id===t);r.value=String(i?.settings?.[e.key]??e.options[0]?.value??``),r.addEventListener(`change`,()=>{Ll(t,e.key,r.value),Xl()}),n.appendChild(r)}return n}function tf(e){if(e.settings.length===0)return null;let t=document.createElement(`div`);t.className=`dm-settings`,t.id=`dm-settings-${e.id}`;for(let n of e.settings)t.appendChild(ef(n,e.id));return t}function nf(e){let t=X.dashboard.widgets.find(t=>t.id===e);if(!t)return;let n=document.getElementById(`dm-settings-${e}`);if(!n)return;let r=n.querySelectorAll(`.dm-settings-value`);for(let e of r){let n=e.dataset.settingKey;n&&t.settings[n]!==void 0&&(e.textContent=String(t.settings[n]))}}function rf(e){let t=document.createElement(`div`);t.className=`dm-widget-row`;let n=X.dashboard.widgets.find(t=>t.id===e.id);if(!n)return t;let r=document.createElement(`label`);r.className=`dm-toggle`;let i=document.createElement(`input`);i.type=`checkbox`,i.checked=n.visible,i.addEventListener(`change`,()=>{Fl(e.id),Xl()});let a=document.createElement(`span`);a.className=`dm-toggle-slider`,r.appendChild(i),r.appendChild(a),t.appendChild(r);let o=document.createElement(`span`);o.className=`dm-widget-title`,o.textContent=e.title,t.appendChild(o);let s=document.createElement(`select`);s.className=`dm-pos-select`;for(let e of Xd){let t=document.createElement(`option`);t.value=e.value,t.textContent=e.label,n.position===e.value&&(t.selected=!0),s.appendChild(t)}return s.addEventListener(`change`,()=>{zl(e.id,s.value),Xl()}),t.appendChild(s),t}function af(){if(!document.getElementById(`dashboard-manager`)&&!document.getElementById(`canvas-wrap`))throw Error(`#canvas-wrap not found`);let e=document.getElementById(`dashboard-manager`);e.innerHTML=``;let t=document.createElement(`div`);t.className=`dm-header`;let n=document.createElement(`span`);n.className=`dm-header-title`,n.textContent=`Widget Manager`;let r=document.createElement(`button`);r.className=`dm-close-btn`,r.textContent=`✕`,r.addEventListener(`click`,()=>{Vl(),cf()}),t.appendChild(n),t.appendChild(r),e.appendChild(t);let i=document.createElement(`div`);i.className=`dm-body`;for(let e of Yd){i.appendChild(rf(e));let t=tf(e);t&&i.appendChild(t)}e.appendChild(i);let a=document.createElement(`div`);a.className=`dm-actions`;let o=document.createElement(`button`);o.className=`dm-btn`,o.textContent=X.dashboard.collapsed?`Expand All`:`Collapse All`,o.addEventListener(`click`,()=>{X.dashboard.collapsed=!X.dashboard.collapsed,o.textContent=X.dashboard.collapsed?`Expand All`:`Collapse All`,Xl()}),a.appendChild(o);let s=document.createElement(`button`);return s.className=`dm-btn danger`,s.textContent=`Reset Layout`,s.addEventListener(`click`,()=>{Hl(),cf(),Xl()}),a.appendChild(s),e.appendChild(a),e}function of(){if(document.getElementById(`btn-dashboard-manager`))return;let e=document.getElementById(`editor-toolbar`);if(!e)return;let t=e.querySelector(`[data-action="screenshot"]`)?.closest(`.toolbar-group`),n=document.createElement(`button`);if(n.id=`btn-dashboard-manager`,n.type=`button`,n.dataset.tip=`Widget Manager`,n.innerHTML=`☰`,n.addEventListener(`click`,()=>{Vl(),cf()}),t){let e=document.createElement(`div`);e.className=`toolbar-sep`,t.parentNode?.insertBefore(e,t.nextSibling);let r=document.createElement(`div`);r.className=`toolbar-group`,r.appendChild(n),t.parentNode?.insertBefore(r,e.nextSibling)}else{let t=e.querySelector(`.toolbar-spacer`);t?t.parentNode?.insertBefore(n,t.nextSibling):e.appendChild(n)}Zd=n}function sf(){$d(),af(),of(),cf()}function cf(){let e=document.getElementById(`dashboard-manager`);e&&e.classList.toggle(`visible`,X.dashboard.managerOpen),Zd&&Zd.classList.toggle(`active`,X.dashboard.managerOpen)}var lf=`
query($login:String!) {
  user(login:$login) {
...
`;async function uf(e,t){try{let n=await fetch(`https://api.github.com/graphql`,{method:`POST`,headers:{Authorization:`Bearer ${t}`,"Content-Type":`application/json`},body:JSON.stringify({query:lf,variables:{login:e}})});if(!n.ok)return console.warn(`GitHub API returned ${n.status} for language fetch`),[];let r=await n.json();if(r.errors?.length)return console.warn(`GitHub GraphQL errors (languages):`,r.errors[0].message),[];let i=r.data?.user?.repositories?.nodes;if(!i||i.length===0)return[];let a=new Map;for(let e of i){let t=e?.languages?.edges;if(t)for(let e of t){if(!e?.node?.name)continue;let t=e.node.name,n=e.node.color||`#8b949e`,r=e.size||0,i=a.get(t);i?(i.size+=r,i.color===`#8b949e`&&n!==`#8b949e`&&(i.color=n)):a.set(t,{name:t,color:n,size:r})}}if(a.size===0)return[];let o=Array.from(a.values()).reduce((e,t)=>e+t.size,0);return o===0?[]:Array.from(a.values()).map(e=>({name:e.name,color:e.color,size:e.size,percentage:Math.round(e.size/o*1e4)/100})).sort((e,t)=>t.percentage-e.percentage)}catch(e){return console.warn(`Failed to fetch GitHub languages:`,e.message),[]}}async function df(){let e=document.getElementById(`inp-user`)?.value?.trim(),t=document.getElementById(`inp-token`)?.value?.trim();!e||!t||(Z(`languages`,await uf(e,t)),Xl())}function ff(e,t){let n=du[fu]||du.github,r=X.contributions?.total??X.cellData.reduce((e,t)=>Math.max(e,t.count),0),i=document.createElement(`div`);i.style.cssText=`display:flex;flex-direction:column;gap:4px`;let a=document.createElement(`div`);a.style.cssText=`font-size:9px;color:var(--muted);text-transform:uppercase;letter-spacing:0.08em;font-family:var(--mono);margin-bottom:2px`,a.textContent=`Contributions`,i.appendChild(a);let o=document.createElement(`div`);o.style.cssText=`height:20px;border-radius:3px;border:1px solid rgba(255,255,255,0.1);overflow:hidden`,o.style.background=`linear-gradient(to right, ${n.colors.join(`, `)})`,i.appendChild(o);let s=document.createElement(`div`);s.style.cssText=`display:flex;justify-content:space-between;font-size:10px;font-family:var(--mono);color:var(--text)`,s.innerHTML=`<span>${0 .toLocaleString()}</span><span style="color:var(--muted);font-size:9px">per day</span><span style="font-weight:600">${r.toLocaleString()}</span>`,i.appendChild(s),e.appendChild(i)}Wl(`legend`,ff);function pf(e,t){let n=X.contributions,r=X.grid,i=X.cellData,a=n?.total??0,o=r?.cells?.length??0,s=n?.username||`—`,c=i.length>0?Math.max(...i.map(e=>e.count)):0,l=i.filter(e=>e.count>0).length,u=o>0?l/o*100:0,d=i.filter(e=>e.intensity>0&&e.intensity<=.33).length,f=i.filter(e=>e.intensity>.33&&e.intensity<=.66).length,p=i.filter(e=>e.intensity>.66).length,m=document.createElement(`div`);m.style.cssText=`display:flex;gap:16px;margin-bottom:6px`;let h=(e,t)=>{let n=document.createElement(`div`);return n.innerHTML=`<div style="font-size:18px;font-weight:700;color:var(--accent);line-height:1.2">${e}</div><div style="font-size:8px;color:var(--muted);text-transform:uppercase;letter-spacing:0.05em">${t}</div>`,n};m.appendChild(h(a.toLocaleString(),`Contributions`)),m.appendChild(h(o.toLocaleString(),`Cells`)),m.appendChild(h(`${Math.round(u)}%`,`Consistency`)),e.appendChild(m);let g=document.createElement(`div`);g.style.cssText=`display:flex;gap:12px;font-size:9px;color:var(--muted);margin-bottom:6px`,g.innerHTML=`<span>User: ${s}</span><span>Max: ${c.toLocaleString()}</span><span>Avg: ${o>0?(a/o).toFixed(1):`0`}/d</span>`,e.appendChild(g);let _=d+f+p||1,v=document.createElement(`div`);v.style.cssText=`display:flex;height:5px;border-radius:3px;overflow:hidden;margin-top:2px`,[{pct:d/_,color:hu(.16,fu)},{pct:f/_,color:hu(.5,fu)},{pct:p/_,color:hu(.83,fu)}].forEach(e=>{if(e.pct>0){let t=document.createElement(`div`);t.style.cssText=`width:${e.pct*100}%;height:100%;background:${e.color}`,v.appendChild(t)}}),e.appendChild(v);let y=document.createElement(`div`);y.style.cssText=`display:flex;justify-content:space-between;font-size:8px;color:var(--muted);margin-top:2px`,y.innerHTML=`<span>Low ${d}</span><span>Med ${f}</span><span>High ${p}</span>`,e.appendChild(y)}Wl(`stats`,pf);function mf(e,t){let n=Rl(`languages`,`maxItems`,5),r=(X.languages??[]).slice(0,n);if(e.style.fontSize=`10px`,e.style.padding=`6px 8px`,r.length===0){e.textContent=`No language data`,e.style.color=`rgba(255,255,255,0.4)`,e.style.fontStyle=`italic`,e.style.padding=`12px 8px`,e.style.textAlign=`center`;return}e.style.display=`flex`,e.style.flexDirection=`column`,e.style.gap=`6px`;for(let t of r){let n=document.createElement(`div`);n.style.display=`flex`,n.style.alignItems=`center`,n.style.gap=`6px`;let r=document.createElement(`span`);r.style.width=`8px`,r.style.height=`8px`,r.style.borderRadius=`50%`,r.style.flexShrink=`0`,r.style.background=t.color||`#888`,r.style.border=`1px solid rgba(255,255,255,0.1)`;let i=document.createElement(`span`);i.textContent=t.name,i.style.color=`#e6edf3`,i.style.minWidth=`60px`,i.style.fontSize=`10px`,i.style.flexShrink=`0`;let a=document.createElement(`div`);a.style.flex=`1`,a.style.height=`8px`,a.style.background=`rgba(255,255,255,0.08)`,a.style.borderRadius=`4px`,a.style.overflow=`hidden`;let o=document.createElement(`div`);o.style.width=`${t.percentage}%`,o.style.height=`100%`,o.style.background=t.color||`#888`,o.style.borderRadius=`4px`,o.style.transition=`width 0.3s ease`,a.appendChild(o);let s=document.createElement(`span`);s.textContent=`${t.percentage.toFixed(1)}%`,s.style.color=`rgba(255,255,255,0.5)`,s.style.fontSize=`9px`,s.style.minWidth=`38px`,s.style.textAlign=`right`,s.style.fontVariantNumeric=`tabular-nums`,n.appendChild(r),n.appendChild(i),n.appendChild(a),n.appendChild(s),e.appendChild(n)}}Wl(`languages`,mf);function hf(e,t){let n=Rl(`scaleBar`,`unit`,`normalized`),r=gf((X.grid?.cellSize??1)*3);e.style.fontSize=`10px`,e.style.padding=`6px 8px`,e.style.display=`flex`,e.style.flexDirection=`column`,e.style.alignItems=`center`;let i=document.createElement(`div`);i.style.position=`relative`,i.style.width=`120px`,i.style.height=`12px`;let a=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);a.setAttribute(`width`,`120`),a.setAttribute(`height`,`12`),a.style.display=`block`;for(let e=0;e<3;e++){let t=document.createElementNS(`http://www.w3.org/2000/svg`,`rect`),n=e*40;t.setAttribute(`x`,`${n}`),t.setAttribute(`y`,`0`),t.setAttribute(`width`,`40`),t.setAttribute(`height`,`10`),t.setAttribute(`fill`,e%2==0?`#e6edf3`:`#1a1a2e`),a.appendChild(t)}for(let e=0;e<=3;e++){let t=e/3*120,n=document.createElementNS(`http://www.w3.org/2000/svg`,`line`);n.setAttribute(`x1`,`${t}`),n.setAttribute(`y1`,`10`),n.setAttribute(`x2`,`${t}`),n.setAttribute(`y2`,`12`),n.setAttribute(`stroke`,`#e6edf3`),n.setAttribute(`stroke-width`,`1`),a.appendChild(n)}i.appendChild(a),e.appendChild(i);let o=document.createElement(`div`);o.style.display=`flex`,o.style.justifyContent=`space-between`,o.style.width=`120px`,o.style.marginTop=`2px`,o.style.color=`rgba(255,255,255,0.6)`,o.style.fontSize=`9px`;let s=document.createElement(`span`);s.textContent=`0`;let c=document.createElement(`span`);c.textContent=_f(r,n);let l=document.createElement(`span`);l.textContent=_f(r*3,n),o.appendChild(s),o.appendChild(c),o.appendChild(l),e.appendChild(o)}function gf(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return n<=1?t:n<=2?2*t:n<=5?5*t:10*t}function _f(e,t){let n=Math.round(e*100)/100;return t===`normalized`?`${n}`:`${n} ${t}`}Wl(`scaleBar`,hf);var vf=0,yf=0,bf=null;function xf(e,t){let n=Rl(`coordinates`,`decimals`,2);bf=e,bf.id=`coords-body`,bf.style.fontSize=`10px`,bf.style.padding=`4px 8px`,bf.style.whiteSpace=`pre`,bf.style.fontFamily=`ui-monospace, SFMono-Regular, SF Mono, Consolas, monospace`,bf.style.fontVariantNumeric=`tabular-nums`,bf.style.minWidth=`140px`,Sf(e,vf,yf,n)}function Sf(e,t,n,r){let i=X.coordSystem,a=X.geoBounds;if(i===`wgs84`||i===`mercator`){let i=a?Cf(a.minLon,a.maxLon,t):t,o=a?Cf(a.minLat,a.maxLat,n):n;e.textContent=`Lon: ${i.toFixed(r)}\nLat: ${o.toFixed(r)}`}else e.textContent=`X: ${t.toFixed(Math.max(r,2))}\nY: ${n.toFixed(Math.max(r,2))}`}function Cf(e,t,n){return e+(t-e)*n}Wl(`coordinates`,xf);function wf(e,t){let n=Rl(`distribution`,`bins`,8),r=X.cellData;if(e.style.fontSize=`10px`,e.style.padding=`4px 8px`,!r||r.length===0){e.textContent=`No contribution data`,e.style.color=`rgba(255,255,255,0.4)`,e.style.fontStyle=`italic`,e.style.padding=`12px 8px`,e.style.textAlign=`center`;return}let i=r.map(e=>e.count),a=Math.max(...i),o=Math.min(...i),s=a-o,c=s>0?s/n:1,l=[];for(let e=0;e<=n;e++)l.push(o+e*c);let u=Array(n).fill(0);for(let e of i)if(s>0){let t=Math.min(Math.floor((e-o)/c),n-1);e===a&&(t=n-1),u[t]++}else u[n-1]++;let d=Math.max(...u),f=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);f.setAttribute(`width`,`100%`),f.setAttribute(`height`,`80`),f.setAttribute(`viewBox`,`0 0 100 80`),f.setAttribute(`preserveAspectRatio`,`none`),f.style.display=`block`;let p=100/n,m=Math.max(p-1,1);for(let e=0;e<n;e++){let t=d>0?u[e]/d*65:0,r=e*p+1/2,i=73-t,a=document.createElementNS(`http://www.w3.org/2000/svg`,`rect`);a.setAttribute(`x`,String(r)),a.setAttribute(`y`,String(i)),a.setAttribute(`width`,String(m)),a.setAttribute(`height`,String(Math.max(t,0))),a.setAttribute(`fill`,`#39d353`);let o=.25+e/Math.max(n-1,1)*.75;a.setAttribute(`opacity`,o.toFixed(2));let s=l[e],c=l[e+1],h=Tf(s,c),g=document.createElementNS(`http://www.w3.org/2000/svg`,`title`);g.textContent=`${h}: ${u[e]} cell${u[e]===1?``:`s`}`,a.appendChild(g),f.appendChild(a)}if(d>0){let e=u.indexOf(d),t=e*p+p/2,n=73-u[e]/d*65,r=document.createElementNS(`http://www.w3.org/2000/svg`,`text`);r.setAttribute(`x`,String(t)),r.setAttribute(`y`,String(n-3)),r.setAttribute(`text-anchor`,`middle`),r.setAttribute(`fill`,`#39d353`),r.setAttribute(`font-size`,`8`),r.setAttribute(`font-weight`,`600`),r.textContent=String(d),f.appendChild(r)}e.appendChild(f)}function Tf(e,t){let n=e=>e>=1e3?e.toLocaleString():Number.isInteger(e)?String(e):e.toFixed(1);return`${n(e)}–${n(t)}`}Wl(`distribution`,wf);function Ef(e,t){let n=Rl(`timeline`,`days`,90),r=X.contributions?.days??[];if(e.style.fontSize=`10px`,e.style.padding=`4px 8px`,r.length===0){e.textContent=`No timeline data`,e.style.color=`rgba(255,255,255,0.4)`,e.style.fontStyle=`italic`,e.style.padding=`12px 8px`,e.style.textAlign=`center`;return}let i=r.slice(-n),a=i.length,o=Math.max(...i.map(e=>e.contributionCount),1),s=`tl-fill-`+Date.now()+`-`+Math.random().toString(36).slice(2,6),c=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);c.setAttribute(`width`,`100%`),c.setAttribute(`height`,`60`),c.setAttribute(`viewBox`,`0 0 100 60`),c.setAttribute(`preserveAspectRatio`,`none`),c.style.display=`block`;let l=document.createElementNS(`http://www.w3.org/2000/svg`,`defs`),u=document.createElementNS(`http://www.w3.org/2000/svg`,`linearGradient`);u.setAttribute(`id`,s),u.setAttribute(`x1`,`0`),u.setAttribute(`y1`,`0`),u.setAttribute(`x2`,`0`),u.setAttribute(`y2`,`1`);let d=document.createElementNS(`http://www.w3.org/2000/svg`,`stop`);d.setAttribute(`offset`,`0%`),d.setAttribute(`stop-color`,`#39d353`),d.setAttribute(`stop-opacity`,`0.35`);let f=document.createElementNS(`http://www.w3.org/2000/svg`,`stop`);f.setAttribute(`offset`,`100%`),f.setAttribute(`stop-color`,`#39d353`),f.setAttribute(`stop-opacity`,`0`),u.appendChild(d),u.appendChild(f),l.appendChild(u),c.appendChild(l);let p=a,m=e=>p>1?e/(p-1)*98+1:100/2,h=e=>54-e/o*40,g=[];for(let e=0;e<p;e++){let t=m(e),n=h(i[e].contributionCount);g.push(`${t.toFixed(1)},${n.toFixed(1)}`)}let _=[`${m(0).toFixed(1)},54`,...g,`${m(p-1).toFixed(1)},54`],v=document.createElementNS(`http://www.w3.org/2000/svg`,`polygon`);v.setAttribute(`points`,_.join(` `)),v.setAttribute(`fill`,`url(#${s})`),c.appendChild(v);let y=document.createElementNS(`http://www.w3.org/2000/svg`,`polyline`);y.setAttribute(`points`,g.join(` `)),y.setAttribute(`fill`,`none`),y.setAttribute(`stroke`,`#39d353`),y.setAttribute(`stroke-width`,`1.5`),y.setAttribute(`stroke-linejoin`,`round`),y.setAttribute(`stroke-linecap`,`round`),c.appendChild(y);let b=Df(i,3);for(let e of b){let t=m(e),n=h(i[e].contributionCount),r=document.createElementNS(`http://www.w3.org/2000/svg`,`circle`);r.setAttribute(`cx`,t.toFixed(1)),r.setAttribute(`cy`,n.toFixed(1)),r.setAttribute(`r`,`2`),r.setAttribute(`fill`,`#39d353`),r.setAttribute(`stroke`,`#0d1117`),r.setAttribute(`stroke-width`,`1`),c.appendChild(r)}let x=i.reduce((e,t,n,r)=>t.contributionCount>r[e].contributionCount?n:e,0),S=i[x].contributionCount;if(S>0){let e=m(x),t=h(S),n=document.createElementNS(`http://www.w3.org/2000/svg`,`text`);n.setAttribute(`x`,e.toFixed(1)),n.setAttribute(`y`,String(t-5)),n.setAttribute(`text-anchor`,`middle`),n.setAttribute(`fill`,`#39d353`),n.setAttribute(`font-size`,`7`),n.setAttribute(`font-weight`,`600`),n.textContent=`Max: ${S}`,c.appendChild(n)}e.appendChild(c)}function Df(e,t){if(e.length===0)return[];let n=e.map((e,t)=>({count:e.contributionCount,idx:t}));return n.sort((e,t)=>t.count-e.count),n.slice(0,Math.min(t,n.length)).map(e=>e.idx)}Wl(`timeline`,Ef);var Of={1:0,2:1,3:2,4:3,5:4,6:5,0:6},kf={"01":`Jan`,"02":`Feb`,"03":`Mar`,"04":`Apr`,"05":`May`,"06":`Jun`,"07":`Jul`,"08":`Aug`,"09":`Sep`,10:`Oct`,11:`Nov`,12:`Dec`};function Af(e,t){let n=Rl(`activity`,`days`,49),r=X.contributions?.days??[],i=du[fu]?.colors??du.github.colors;if(e.style.fontSize=`10px`,e.style.padding=`4px`,r.length===0){e.textContent=`No activity data`,e.style.color=`rgba(255,255,255,0.4)`,e.style.fontStyle=`italic`,e.style.padding=`12px 8px`,e.style.textAlign=`center`;return}let a=r.slice(-Math.min(n,r.length)),o=a.reduce((e,t)=>Math.max(e,t.contributionCount),0),s=Of[a[0].weekday]??0,c=s+a.length,l=3+(Math.ceil(c/7)*8-2)+3,u=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);u.setAttribute(`width`,`86`),u.setAttribute(`height`,`${l}`),u.setAttribute(`viewBox`,`0 0 86 ${l}`),u.style.display=`block`;for(let e=0;e<a.length;e++){let t=a[e],n=(s+e)%7,r=Math.floor((s+e)/7),c=28+n*8,l=3+r*8,d=jf(o>0?t.contributionCount/o:0,i),f=document.createElementNS(`http://www.w3.org/2000/svg`,`rect`);f.setAttribute(`x`,`${c}`),f.setAttribute(`y`,`${l}`),f.setAttribute(`width`,`6`),f.setAttribute(`height`,`6`),f.setAttribute(`fill`,d),f.setAttribute(`rx`,`1`),u.appendChild(f)}let d=``;for(let e=0;e<a.length;e++){let t=a[e].date.substring(5,7);if(t!==d){let n=Math.floor((s+e)/7),r=kf[t]??t,i=document.createElementNS(`http://www.w3.org/2000/svg`,`text`);i.setAttribute(`x`,`4`),i.setAttribute(`y`,`${3+n*8+6-1}`),i.setAttribute(`fill`,`rgba(255,255,255,0.5)`),i.setAttribute(`font-size`,`7`),i.setAttribute(`font-family`,`ui-monospace, SFMono-Regular, monospace`),i.textContent=r,u.appendChild(i),d=t}}e.appendChild(u)}function jf(e,t){return e<=0||t.length===0?t[0]??`#161b22`:t[Math.min(Math.floor(e*(t.length-1)),t.length-2)]??t[t.length-1]}Wl(`activity`,Af);function Mf(e,t){e.style.fontSize=`10px`,e.style.padding=`4px`,e.style.display=`flex`,e.style.alignItems=`center`,e.style.justifyContent=`center`;let n=X.poly??[],r=X.grid?.cells??[];if(n.length<3){e.textContent=`No boundary loaded`,e.style.color=`rgba(255,255,255,0.4)`,e.style.fontStyle=`italic`,e.style.padding=`12px 8px`,e.style.textAlign=`center`;return}let i=Nf(n,r),a=Math.max(i.maxX-i.minX,1e-6),o=Math.max(i.maxY-i.minY,1e-6),s=Math.min(a/o*80,180)*(o/a),c=Math.min(s,80),l=a/o*c,u=l+8,d=c+8,f=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);f.setAttribute(`width`,`${Math.round(l)}`),f.setAttribute(`height`,`${Math.round(c)}`),f.setAttribute(`viewBox`,`0 0 ${u} ${d}`),f.style.display=`block`,f.setAttribute(`shape-rendering`,`crispEdges`);let p=e=>4+(e-i.minX)/a*l,m=e=>4+(e-i.minY)/o*c,h=n.map(e=>`${p(e[0]).toFixed(2)},${m(e[1]).toFixed(2)}`).join(` `),g=document.createElementNS(`http://www.w3.org/2000/svg`,`polygon`);g.setAttribute(`points`,h),g.setAttribute(`fill`,`transparent`),g.setAttribute(`stroke`,`#666666`),g.setAttribute(`stroke-width`,`1`),f.appendChild(g);for(let e of r){let t=p(e.cx),n=m(e.cy),r=document.createElementNS(`http://www.w3.org/2000/svg`,`circle`);r.setAttribute(`cx`,t.toFixed(2)),r.setAttribute(`cy`,n.toFixed(2)),r.setAttribute(`r`,`1`),r.setAttribute(`fill`,`#26a641`),r.setAttribute(`stroke`,`none`),f.appendChild(r)}e.appendChild(f)}function Nf(e,t){let n=1/0,r=1/0,i=-1/0,a=-1/0;for(let t of e)t[0]<n&&(n=t[0]),t[0]>i&&(i=t[0]),t[1]<r&&(r=t[1]),t[1]>a&&(a=t[1]);for(let e of t)e.cx<n&&(n=e.cx),e.cx>i&&(i=e.cx),e.cy<r&&(r=e.cy),e.cy>a&&(a=e.cy);isFinite(n)||(n=-.5,r=-.5,i=.5,a=.5);let o=(i-n)*.05||.05,s=(a-r)*.05||.05;return{minX:n-o,minY:r-s,maxX:i+o,maxY:a+s}}Wl(`overview`,Mf);var Pf=document.getElementById(`canvas-main`),Ff,If,$,Lf,Rf,zf,Bf,Vf;hl(gl);function Hf(){Ff=new ml({canvas:Pf,antialias:!0,alpha:!1,preserveDrawingBuffer:!0}),Ff.setPixelRatio(Math.min(devicePixelRatio,2)),Ff.shadowMap.enabled=!0,Ff.shadowMap.type=2,If=new mn;let e=Pf.clientWidth/Pf.clientHeight,t=1.3;$=new Ea(-1.3*e/2,t*e/2,t/2,-1.3/2,.01,100),If.add(new ka(16777215,.55)),Lf=new Oa(16777215,1.1),Lf.position.set(2,4,3),Lf.castShadow=!0,Lf.shadow.mapSize.set(1024,1024),If.add(Lf);let n=new Oa(6719692,.25);n.position.set(-2,2,-3),If.add(n),Bf=new Xr(new Fi(4,4),new Ii({opacity:.12})),Bf.rotation.x=-Math.PI/2,Bf.receiveShadow=!0,If.add(Bf),Yf()}function Uf(){let e=X.yaw*Math.PI/180,t=X.pitch*Math.PI/180,n=2.5;$.position.set(n*Math.sin(e)*Math.cos(t),n*Math.sin(t),n*Math.cos(e)*Math.cos(t)),$.lookAt(0,0,0),$.up.set(0,1,0);let r=Pf.clientWidth/Pf.clientHeight,i=X.zoom;$.left=-i*r/2,$.right=i*r/2,$.top=i/2,$.bottom=-i/2,$.updateProjectionMatrix()}function Wf(){if(Rf&&=(If.remove(Rf),Rf.geometry.dispose(),Rf.material.dispose(),null),zf&&=(If.remove(zf),zf.geometry.dispose(),null),!X.grid)return;let{cells:e,cellSize:t,gridType:n}=X.grid,r=e.length,i=X.heightScale,a=X.gap,o;if(n===`square`){let e=t*(1-a);o=new Ni(e,1,e)}else{let e=t*.5*(1-a);o=new Pi(e,e,1,6)}let s=new Ji;Rf=new ci(o,s,r),Rf.castShadow=!0;let c=new rn,l=new q;if(e.forEach((e,t)=>{let n=X.cellData[t]||{intensity:0,count:0},r=Math.max(.008,n.intensity*i*.12+.008);c.position.set(e.cx-.5,r/2,e.cy-.5),c.scale.set(1,r,1),c.updateMatrix(),Rf.setMatrixAt(t,c.matrix);let[a,o,s]=gu(hu(n.intensity,fu));l.setRGB(a,o,s),Rf.setColorAt(t,l)}),Rf.instanceMatrix.needsUpdate=!0,Rf.instanceColor&&(Rf.instanceColor.needsUpdate=!0),If.add(Rf),X.showBoundary&&Cl().layerVisibility.boundary){let e=X.poly.map(([e,t])=>new W(e-.5,.02,t-.5));zf=new Di(new cr().setFromPoints(e),new _i({color:6710886})),If.add(zf)}qf()}function Gf(e,t=`#888888`,n=1){let r=document.createElement(`canvas`),i=r.getContext(`2d`);i.font=`48px "IBM Plex Mono", monospace`;let a=i.measureText(e),s=Math.ceil(a.width)+8;r.width=s,r.height=56,i.font=`48px "IBM Plex Mono", monospace`,i.fillStyle=t,i.textBaseline=`middle`,i.fillText(e,4,56/2);let c=new ki(r);c.minFilter=o;let l=new Or(new mr({map:c,transparent:!0})),u=n*.15;return l.scale.set(s/400*u,56/400*u,1),l}function Kf(e,t){let n=Math.abs(e),r=t?e>=0?`N`:`S`:e>=0?`E`:`W`;return`${n.toFixed(1)}°${r}`}function qf(){Vf&&(If.remove(Vf),Vf.traverse(e=>{e.geometry&&e.geometry.dispose();let t=e;t.material&&(t.material.map&&t.material.map.dispose(),t.material.dispose())}));let e=X.coordSystem===`wgs84`||X.coordSystem===`mercator`,t=X.fileType!==null;if(!e||!X.geoBounds||!X.showCoordAxes||!t||!Cl().layerVisibility.axes)return;Vf=new an;let{minLon:n,maxLon:r,minLat:i,maxLat:a}=X.geoBounds,o=X.coordAxesLineColor,s=X.coordAxesLabelColor,c=X.coordAxesScale,l=.01,u=X.coordAxesPosition===`outside`,d=X.coordAxesXOffset??.04,f=X.coordAxesYOffset??.04,p=X.coordAxesTickLength??.015,m=X.coordAxesLabelOffset??.03,h=u?p:-p,g=u?m:-m,_=r-n,v=a-i,y=Math.max(_,v),b=_/y,x=v/y,S=-b/2,C=b/2,w=-x/2,T=x/2,E=S-(u?f:-f),D=T+(u?d:-d),O=new _i({color:o}),k=new cr().setFromPoints([new W(E,l,D),new W(C,l,D)]);Vf.add(new Ti(k,O));let A=new cr().setFromPoints([new W(E,l,w),new W(E,l,D)]);Vf.add(new Ti(A,O));function ee(e,t=4){let n=e/t,r=Math.floor(Math.log10(n)),i=n/10**r,a;return a=i<=1.5?1:i<=3?2:i<=7?5:10,a*10**r}let j=ee(_),M=Math.ceil(n/j)*j;for(let e=M,t=0;e<=r+j*.01;e=M+t*j,t++){let t=S+(e-n)/_*b,r=new cr().setFromPoints([new W(t,l,D),new W(t,l,D+h)]);Vf.add(new Ti(r,O));let i=Gf(Kf(Math.round(e*1e3)/1e3,!1),s,c);i.position.set(t,l,D+h+g),Vf.add(i)}let te=ee(v),ne=Math.ceil(i/te)*te;for(let e=ne,t=0;e<=a+te*.01;e=ne+t*te,t++){let t=T-(e-i)/v*x,n=new cr().setFromPoints([new W(E,l,t),new W(E-h,l,t)]);Vf.add(new Ti(n,O));let r=Gf(Kf(Math.round(e*1e3)/1e3,!0),s,c);r.position.set(E-h-g,l,t),Vf.add(r)}If.add(Vf)}function Jf(){if(!(!Ff||!If))if(X.fogEnabled&&!If.fog?If.fog=new pn(X.background,X.fogDensity):X.fogEnabled&&If.fog?If.fog.density=X.fogDensity:X.fogEnabled||(If.fog=null),Ff.toneMapping=X.toneMapping,Ff.toneMappingExposure=1,X.envMapEnabled&&!If.environment){let e=new xo(Ff);e.compileCubemapShader();let t=e.fromScene(new Hu,.04);If.environment=t.texture,e.dispose()}else X.envMapEnabled||(If.environment=null)}function Yf(){requestAnimationFrame(Yf);let e=Pf.clientWidth,t=Pf.clientHeight;(Ff.domElement.width!==e||Ff.domElement.height!==t)&&(Ff.setSize(e,t,!1),Uf()),Eu()&&Wf(),Jf();let n=Cl();if(n.activeMeasurement||n.measurements.length>0){let e=Pf.getBoundingClientRect();Vd($,e)}Ff.setClearColor(X.background,1),Ff.render(If,$)}var Xf={active:!1,lx:0,ly:0};Pf.addEventListener(`mousedown`,e=>{Xf={active:!0,lx:e.clientX,ly:e.clientY}}),window.addEventListener(`mouseup`,()=>{Xf.active=!1}),window.addEventListener(`mousemove`,e=>{if(!Xf.active)return;let t=e.clientX-Xf.lx,n=e.clientY-Xf.ly;Xf.lx=e.clientX,Xf.ly=e.clientY,Z(`yaw`,parseFloat(((X.yaw+t*.4+360)%360).toFixed(1))),Z(`pitch`,parseFloat(Math.max(5,Math.min(89,X.pitch-n*.3)).toFixed(1))),sp(`yaw`),sp(`pitch`),Uf()}),Pf.addEventListener(`wheel`,e=>{e.preventDefault();let t=e.deltaY>0?1.08:.93;X.zoom=Math.max(.5,Math.min(4,X.zoom*t));let n=Pf.clientWidth/Pf.clientHeight;$.left=-X.zoom*n/2,$.right=X.zoom*n/2,$.top=X.zoom/2,$.bottom=-X.zoom/2,$.updateProjectionMatrix()},{passive:!1});var Zf=new qa,Qf=new U,$f=document.getElementById(`tooltip`);Pf.addEventListener(`mousemove`,e=>{if(!Rf||Xf.active){$f.classList.remove(`visible`);return}let t=Pf.getBoundingClientRect();Qf.x=(e.clientX-t.left)/t.width*2-1,Qf.y=-((e.clientY-t.top)/t.height)*2+1,Zf.setFromCamera(Qf,$);let n=Zf.intersectObject(Rf);if(n.length>0){let r=n[0].instanceId;if(r!==void 0){let n=X.cellData[r];if(n){$f.innerHTML=n.date?`<strong>${n.date}</strong><br/>${n.count} contribution${n.count===1?``:`s`}`:`<span style="color:var(--muted)">No data</span>`,$f.style.left=e.clientX-t.left+12+`px`,$f.style.top=e.clientY-t.top-28+`px`,$f.classList.add(`visible`),Cl().activeTool===`select`&&(Al([r]),Jd());return}}}$f.classList.remove(`visible`)}),Pf.addEventListener(`mouseleave`,()=>$f.classList.remove(`visible`));var ep=!1;Pf.addEventListener(`mousedown`,()=>{ep=!1}),Pf.addEventListener(`mousemove`,e=>{(Cl().activeTool===`measureDistance`||Cl().activeTool===`measureArea`)&&e.buttons>0&&(ep=!0)}),Pf.addEventListener(`mouseup`,e=>{if(ep)return;let t=Cl().activeTool;if(t===`measureDistance`||t===`measureArea`){let t=Pf.getBoundingClientRect();Hd(e.clientX,e.clientY,t,$)&&Vd($,t)}else if(t===`select`&&Rf){let t=Pf.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,r=-((e.clientY-t.top)/t.height)*2+1;Zf.setFromCamera(new U(n,r),$);let i=Zf.intersectObject(Rf);if(i.length>0){let e=i[0].instanceId;e!==void 0&&(Al([e]),Jd())}else Al([]),Jd()}}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&Wd()&&(kl(),Ud())});var tp=null;function np(){[document.getElementById(`legend`),document.getElementById(`stats-bar`)].forEach(e=>{if(!e)return;let t=e.id===`legend`?`legend`:`stats`;e.addEventListener(`mousedown`,n=>{let r=n.target;r.tagName!==`A`&&r.tagName!==`BUTTON`&&r.tagName!==`INPUT`&&(n.preventDefault(),tp={el:e,key:t,lx:n.clientX,ly:n.clientY,startX:X.overlay[`${t}Pos`].x,startY:X.overlay[`${t}Pos`].y},e.classList.add(`dragging`))})})}window.addEventListener(`mousemove`,e=>{if(!tp)return;let t=document.getElementById(`canvas-wrap`).getBoundingClientRect(),n=e.clientX-tp.lx,r=e.clientY-tp.ly,i=n/t.width*100,a=r/t.height*100,o=`${tp.key}Pos`,s=Math.max(0,Math.min(95,tp.startX+i)),c=Math.max(0,Math.min(90,tp.startY+a));X.overlay[o]={x:s,y:c},tp.el.style.left=s+`%`,tp.el.style.top=c+`%`}),window.addEventListener(`mouseup`,()=>{tp&&=(tp.el.classList.remove(`dragging`),null)});function rp(){let e={version:2,generated:new Date().toISOString(),username:X.contributions?.username||``,totalContributions:X.contributions?.total||0,boundary:X.poly,geoBounds:X.geoBounds||void 0,coordSystem:X.coordSystem||void 0,grid:X.grid?{type:X.grid.gridType,count:X.count,cellSize:X.grid.cellSize,cells:X.grid.cells.map((e,t)=>({cx:e.cx,cy:e.cy,date:X.cellData[t]?.date||``,count:X.cellData[t]?.count||0,intensity:X.cellData[t]?.intensity||0}))}:null,config:{camera:{yaw:X.yaw,pitch:X.pitch},render:{heightScale:X.heightScale,showBoundary:X.showBoundary,background:X.background,gap:X.gap},theme:{palette:X.palette},overlay:{legendPos:X.overlay.legendPos,statsPos:X.overlay.statsPos,showLegend:X.overlay.showLegend,showStats:X.overlay.showStats,legendFontSize:X.overlay.legendFontSize,legendBarWidth:X.overlay.legendBarWidth,statsFontSize:X.overlay.statsFontSize,statsInline:X.overlay.statsInline}}},t=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.download=`shapegrid-config-${Date.now()}.json`,r.href=n,r.click(),URL.revokeObjectURL(n)}function ip(e){Z(`daysMode`,e),document.querySelectorAll(`.days-mode-btn`).forEach(e=>e.classList.remove(`active`));let t=document.getElementById(e===`last`?`dm-last`:e===`years`?`dm-years`:`dm-range`);t&&t.classList.add(`active`);let n=document.getElementById(`dm-last-panel`),r=document.getElementById(`dm-years-panel`),i=document.getElementById(`dm-range-panel`);n&&(n.style.display=e===`last`?`block`:`none`),r&&(r.style.display=e===`years`?`block`:`none`),i&&(i.style.display=e===`range`?`block`:`none`)}document.getElementById(`dm-last`).addEventListener(`click`,()=>ip(`last`)),document.getElementById(`dm-years`).addEventListener(`click`,()=>ip(`years`)),document.getElementById(`dm-range`).addEventListener(`click`,()=>ip(`range`));function ap(){let e=document.getElementById(`year-chips`);if(!e)return;e.innerHTML=``;let t=new Date().getFullYear();for(let n=t;n>=t-5;n--){let t=document.createElement(`button`);t.type=`button`,t.className=`year-chip`+(X.selectedYears.has(n)?` active`:``),t.textContent=String(n),t.addEventListener(`click`,()=>{X.selectedYears.has(n)?X.selectedYears.size>1&&X.selectedYears.delete(n):X.selectedYears.add(n),ap()}),e.appendChild(t)}}function op(e){let t=document.getElementById(`inp-${e}`);t&&(Z(e,t.type===`range`?parseFloat(t.value):t.value),cp())}function sp(e){let t=document.getElementById(`inp-${e}`);t&&(t.value=String(X[e]),cp())}function cp(){let e=e=>document.getElementById(e);e(`val-yaw`).textContent=`${X.yaw}°`,e(`val-pitch`).textContent=`${X.pitch}°`,e(`val-days`).textContent=String(e(`inp-days`).value),e(`val-gap`).textContent=X.gap.toFixed(2),e(`val-height`).textContent=`${X.heightScale.toFixed(1)}×`,e(`val-coverage`).textContent=X.coverage.toFixed(2),e(`val-coord-axes-scale`).textContent=X.coordAxesScale.toFixed(1),e(`val-coord-axes-x-offset`).textContent=X.coordAxesXOffset.toFixed(2),e(`val-coord-axes-y-offset`).textContent=X.coordAxesYOffset.toFixed(2),e(`val-coord-axes-tick`).textContent=X.coordAxesTickLength.toFixed(3),e(`val-coord-axes-label-off`).textContent=X.coordAxesLabelOffset.toFixed(2)}[`yaw`,`pitch`,`gap`,`height`,`coverage`].forEach(e=>{let t=document.getElementById(`inp-${e}`);t&&t.addEventListener(`input`,()=>{op(e),[`gap`,`coverage`].includes(e)&&(ku(),ju()),[`yaw`,`pitch`].includes(e)?Uf():Tu()})});var lp=document.getElementById(`inp-count-num`);lp&&lp.addEventListener(`change`,()=>{let e=parseInt(lp.value);if(e>=1&&e<=9999){if(Z(`count`,e),ku(),X.contributions?.username===`demo`)ju();else if(X.contributions&&X.contributions.username!==`demo`){let t=X.grid?.cells.length||e,n=[...X.cellData];Z(`cellData`,Array.from({length:t},(e,t)=>n[t]||{date:``,count:0,intensity:0}))}Tu()}});var up=document.getElementById(`inp-sync-cells`);up&&up.addEventListener(`change`,()=>{dp()});function dp(){if(!up?.checked)return;let e=document.getElementById(`inp-days`);if(!e)return;let t=parseInt(e.value);t>=1&&t<=9999&&lp&&(lp.value=String(t),Z(`count`,t),ku(),X.contributions?.username===`demo`&&ju(),Tu())}var fp=document.getElementById(`inp-days`);fp&&fp.addEventListener(`input`,()=>{document.getElementById(`val-days`).textContent=fp.value,dp()});var pp=document.getElementById(`inp-days-num`);pp&&pp.addEventListener(`change`,()=>{let e=parseInt(pp.value);e>=1&&e<=9999&&fp&&(fp.value=String(e),document.getElementById(`val-days`).textContent=String(e),dp())}),document.getElementById(`inp-bg-color`).addEventListener(`input`,e=>{let t=e.target;t&&(document.getElementById(`inp-bg-hex`).value=t.value,Z(`background`,t.value))}),document.getElementById(`inp-bg-hex`).addEventListener(`change`,e=>{X.background=e.target.value});var mp=()=>{X.fogEnabled&&!If.fog?If.fog=new pn(X.background,X.fogDensity):X.fogEnabled&&If.fog?If.fog.density=X.fogDensity:If.fog=null,Ff.toneMapping=X.toneMapping,Ff.toneMappingExposure=1};document.getElementById(`inp-bloom`).addEventListener(`change`,e=>{X.bloomEnabled=e.target.checked,mp()}),[`bloom-strength`,`bloom-radius`,`bloom-threshold`].forEach(e=>{let t=document.getElementById(`inp-${e}`);if(!t)return;let n=e.replace(/-([a-z])/g,(e,t)=>t.toUpperCase());t.addEventListener(`input`,()=>{X[n]=parseFloat(t.value),mp()})}),document.getElementById(`inp-fog`).addEventListener(`change`,e=>{X.fogEnabled=e.target.checked,mp()}),document.getElementById(`inp-fog-density`).addEventListener(`input`,e=>{X.fogDensity=parseFloat(e.target.value),mp()}),document.getElementById(`inp-env-map`).addEventListener(`change`,e=>{X.envMapEnabled=e.target.checked,mp()}),document.getElementById(`inp-tone-mapping`).addEventListener(`change`,e=>{X.toneMapping=parseInt(e.target.value),mp()}),document.getElementById(`inp-grid-type`).addEventListener(`change`,e=>{let t=e.target;Z(`gridType`,t.value),ku(),ju(),Tu()}),document.getElementById(`inp-boundary`).addEventListener(`change`,e=>{let t=e.target;Z(`showBoundary`,t.checked),Tu()}),document.getElementById(`inp-coord-axes`).addEventListener(`change`,e=>{let t=e.target;Z(`showCoordAxes`,t.checked),Tu()}),[`coord-axes-scale`,`coord-axes-x-offset`,`coord-axes-y-offset`,`coord-axes-tick`,`coord-axes-label-off`].forEach(e=>{let t=document.getElementById(`inp-${e}`);t&&t.addEventListener(`input`,()=>{Z(e.replace(/-([a-z])/g,(e,t)=>t.toUpperCase()),parseFloat(t.value)),cp(),Tu()})}),document.getElementById(`inp-coord-axes-position`).addEventListener(`change`,e=>{let t=e.target;Z(`coordAxesPosition`,t.value),Tu()}),document.getElementById(`inp-coord-axes-line-color`).addEventListener(`input`,e=>{let t=e.target;Z(`coordAxesLineColor`,t.value),Tu()}),document.getElementById(`inp-coord-axes-label-color`).addEventListener(`input`,e=>{let t=e.target;Z(`coordAxesLabelColor`,t.value),Tu()}),document.getElementById(`btn-fetch`).addEventListener(`click`,async()=>{await Ou(),await df()}),document.getElementById(`btn-export`).addEventListener(`click`,()=>{let e=+document.getElementById(`inp-export-w`).value,t=+document.getElementById(`inp-export-h`).value,n=document.getElementById(`inp-export-autocrop`).checked,r=document.getElementById(`inp-export-vertical`).checked,i=+document.getElementById(`inp-export-pad`).value||40;if(r){let n=e;e=t,t=n}let a=document.createElement(`canvas`);a.width=e,a.height=t;let o=a.getContext(`2d`),s=Ff.domElement.width,c=Ff.domElement.height,l=$.left,u=$.right,d=$.top,f=$.bottom;if(n&&X.grid&&X.grid.cells.length>0){let n=X.grid.cells.map(e=>e.cx),r=X.grid.cells.map(e=>e.cy),a=Math.min(...n),o=Math.max(...n),s=Math.min(...r),c=Math.max(...r),l=o-a||1,u=c-s||1,d=e/t,f=i/e*l,p=i/t*u,m=(a+o)/2-.5,h=(s+c)/2-.5,g=(l+f*2)/2,_=(u+p*2)/2;g/_>d?_=g/d:g=_*d,$.left=-g,$.right=g,$.top=_,$.bottom=-_,$.position.x=m,$.position.y=.5,$.position.z=h,$.lookAt(m,0,h),$.updateProjectionMatrix()}else Ff.setSize(e,t,!1),Uf();Ff.render(If,$),o.fillStyle=X.background,o.fillRect(0,0,e,t),o.drawImage(Ff.domElement,0,0,e,t);let p=document.createElement(`a`);p.download=`shapegrid-${Date.now()}.png`,p.href=a.toDataURL(`image/png`),p.click(),Ff.setSize(s,c,!1),$.left=l,$.right=u,$.top=d,$.bottom=f,$.position.x=0,$.position.y=0,$.position.z=0,$.updateProjectionMatrix(),Uf()}),document.getElementById(`btn-export-config`).addEventListener(`click`,rp),document.querySelectorAll(`.preset-btn`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.preset-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.preset;Ql(t),ku(),ju(),Tu()})}),document.querySelectorAll(`.sidebar-tab`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.sidebar-tab`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;document.querySelectorAll(`.tab-panel`).forEach(e=>e.classList.remove(`active`)),document.querySelector(`[data-panel="${t}"]`).classList.add(`active`)})}),document.querySelectorAll(`.boundary-tab`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.boundary-tab`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=`panel-${e.dataset.tab}`;document.querySelectorAll(`.boundary-panel`).forEach(e=>e.classList.remove(`active`)),document.getElementById(t).classList.add(`active`)})});var hp=document.getElementById(`country-search`),gp=document.getElementById(`country-dropdown`),_p=document.getElementById(`country-grid`);function vp(){_p.innerHTML=``;let e=od();if(e.length===0){_p.innerHTML=`<div style="padding:12px;text-align:center;color:var(--muted);font-size:10px">Loading countries...</div>`;return}for(let{code:t,name:n}of e){let e=document.createElement(`button`);e.className=`country-grid-item`,e.innerHTML=`<span class="country-name">${n}</span><span class="country-code">${t}</span>`,e.addEventListener(`click`,()=>bp(t)),_p.appendChild(e)}}function yp(){vp()}function bp(e){let t=cd[e];if(!t)return;let n=wp.value;Z(`poly`,bl(t.coords,n)),Z(`coordSystem`,n===`auto`?_l(t.coords)?`wgs84`:`planar`:n),Z(`country`,e),Z(`preset`,``),Z(`boundaryType`,`country`),Dp(),ku(),ju(),Tu()}hp.addEventListener(`input`,()=>{let e=hp.value.trim();if(!e){gp.innerHTML=``,gp.classList.remove(`visible`),_p.style.display=``,vp();return}let t=sd(e);if(gp.innerHTML=``,_p.style.display=`none`,t.length===0){gp.innerHTML=`<div class="country-option" style="color:var(--muted);font-style:italic">No matches</div>`,gp.classList.add(`visible`);return}t.slice(0,15).forEach(e=>{let t=document.createElement(`div`);t.className=`country-option`,t.innerHTML=`<span>${e.name}</span><span class="country-code">${e.code}</span>`,t.addEventListener(`click`,()=>{hp.value=e.name,gp.innerHTML=``,gp.classList.remove(`visible`),_p.style.display=``,bp(e.code)}),gp.appendChild(t)}),gp.classList.add(`visible`)}),yp();var xp=document.getElementById(`file-input`),Sp=document.getElementById(`file-upload-area`),Cp=document.getElementById(`file-name`),wp=document.getElementById(`inp-country-coord-system`),Tp=document.getElementById(`inp-file-coord-system`),Ep=document.getElementById(`axes-options-section`);Sp.addEventListener(`click`,()=>xp.click()),Sp.addEventListener(`dragover`,e=>{e.preventDefault(),Sp.classList.add(`dragover`)}),Sp.addEventListener(`dragleave`,()=>Sp.classList.remove(`dragover`)),Sp.addEventListener(`drop`,e=>{e.preventDefault(),Sp.classList.remove(`dragover`);let t=e.dataTransfer?.files[0];t&&Op(t)}),xp.addEventListener(`change`,()=>{xp.files?.[0]&&Op(xp.files[0])});function Dp(){let e=X.coordSystem===`wgs84`||X.coordSystem===`mercator`,t=X.fileType!==null;Ep.style.display=e&&t?`block`:`none`}function Op(e){Cp.textContent=e.name,Z(`fileName`,e.name);let t=e.name.split(`.`).pop()?.toLowerCase();if(t===`svg`)Z(`fileType`,`svg`);else if(t===`geojson`||t===`json`)Z(`fileType`,`geojson`);else{Au(`Unsupported file type`,`error`);return}let n=new FileReader;n.onload=()=>{let t=n.result;Z(`fileContent`,t);try{let n;X.fileType===`svg`?(Z(`poly`,lu(t)),Dp()):(n=cu(t,Tp.value),Z(`poly`,n.poly),Z(`geoBounds`,n.geoBounds),Z(`coordSystem`,n.coordSystem),Dp()),Z(`boundaryType`,`file`),ku(),ju(),Tu(),Au(`✓ Loaded ${e.name}`,`ok`)}catch(e){Au(e.message,`error`)}},n.readAsText(e)}wp.addEventListener(`change`,()=>{X.boundaryType===`country`&&X.country&&bp(X.country)}),Tp.addEventListener(`change`,()=>{if(X.fileContent&&X.fileType===`geojson`){let e=cu(X.fileContent,Tp.value);Z(`poly`,e.poly),Z(`geoBounds`,e.geoBounds),Z(`coordSystem`,e.coordSystem),Dp(),ku(),ju(),Tu()}});async function kp(){let e=document.getElementById(`overlay`),t=document.getElementById(`overlay-text`);try{if(t.textContent=`Initialising WebGL…`,!Pf)throw Error(`Canvas element #canvas-main not found`);Hf(),Ap(`inp-yaw`,X.yaw),Ap(`inp-pitch`,X.pitch),Ap(`inp-gap`,X.gap),Ap(`inp-height`,X.heightScale),Ap(`inp-coverage`,X.coverage),Ap(`inp-coord-axes-scale`,X.coordAxesScale),Ap(`inp-coord-axes-x-offset`,X.coordAxesXOffset),Ap(`inp-coord-axes-y-offset`,X.coordAxesYOffset),Ap(`inp-coord-axes-tick`,X.coordAxesTickLength),Ap(`inp-coord-axes-label-off`,X.coordAxesLabelOffset),jp(`inp-grid-type`,X.gridType),jp(`inp-coord-axes-position`,X.coordAxesPosition),Mp(`inp-boundary`,X.showBoundary),Mp(`inp-coord-axes`,X.showCoordAxes);let n=document.getElementById(`inp-bg-hex`),r=document.getElementById(`inp-bg-color`);n&&(n.value=X.background),r&&(r.value=X.background),Mp(`inp-bloom`,X.bloomEnabled),Mp(`inp-fog`,X.fogEnabled),Mp(`inp-env-map`,X.envMapEnabled),Ap(`inp-bloom-strength`,X.bloomStrength),Ap(`inp-bloom-radius`,X.bloomRadius),Ap(`inp-bloom-threshold`,X.bloomThreshold),Ap(`inp-fog-density`,X.fogDensity),jp(`inp-tone-mapping`,String(X.toneMapping)),setTimeout(()=>{Jf()},100);let i=!1;await Nu(`./assets/shapegrid-data.json`)?(i=!0,X.palette&&(_u(X.palette),xu())):(ku(),ju()),Tu(),Uf(),cp(),Bu(),ip(X.daysMode),ap(),i||dp(),Dp(),np(),ad().then(()=>{yp()}),Xl(),bd({zoomToFit:()=>{if(!X.grid||X.grid.cells.length===0)return;let e=X.grid.cells.map(e=>e.cx),t=X.grid.cells.map(e=>e.cy),n=Math.max(Math.max(...e)-Math.min(...e),Math.max(...t)-Math.min(...t))||1;X.zoom=Math.max(.3,Math.min(2.5,n*.8));let r=Pf.clientWidth/Pf.clientHeight;$.left=-X.zoom*r/2,$.right=X.zoom*r/2,$.top=X.zoom/2,$.bottom=-X.zoom/2,$.updateProjectionMatrix()},resetCamera:()=>{X.yaw=30,X.pitch=45,X.zoom=1.3,sp(`yaw`),sp(`pitch`),Uf(),Tu()},topDownView:()=>{X.yaw=0,X.pitch=89,X.zoom=1.3,sp(`yaw`),sp(`pitch`),Uf(),Tu()},screenshot:()=>{let e=+document.getElementById(`inp-export-w`).value,t=+document.getElementById(`inp-export-h`).value,n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`),i=Ff.domElement.width,a=Ff.domElement.height;Ff.setSize(e,t,!1),Uf(),Ff.render(If,$),r.fillStyle=X.background,r.fillRect(0,0,e,t),r.drawImage(Pf,0,0,e,t);let o=document.createElement(`a`);o.download=`shapegrid-${Date.now()}.png`,o.href=n.toDataURL(`image/png`),o.click(),Ff.setSize(i,a,!1),Uf()}}),xd(),Ad(),sf(),setTimeout(()=>{e.classList.add(`hidden`)},400)}catch(e){t.textContent=`Error: ${e.message}`,t.style.color=`var(--danger)`,console.error(`Bootstrap error:`,e)}}function Ap(e,t){let n=document.getElementById(e);n&&(n.value=String(t))}function jp(e,t){let n=document.getElementById(e);n&&(n.value=t)}function Mp(e,t){let n=document.getElementById(e);n&&(n.checked=t)}kp();